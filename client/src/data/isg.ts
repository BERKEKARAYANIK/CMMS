...
export const ISG_YEARLY_TOPIC_DETAILS: Record<IsgYearKey, Record<string, IsgTopicYearDetail>> = {
  '2026': {
    'uygunsuzluk-yillik': {
      ...
      { label: 'Toplam Kayıt', value: `${ISG_SUMMARY_2026.total}`, tone: 'neutral' },
    ...
    'capraz-denetim': {
      ...
      { label: 'Toplam Kayıt', value: '1924', tone: 'neutral' },
  ...
  '2025': {
    'uygunsuzluk-yillik': {
      ...
      { label: 'Toplam Kayıt', value: `${ISG_SUMMARY_2025.total}`, tone: 'neutral' },
...
},
{
  ...
  status: 'ready',
  note: 'Ramak kala gostergeleri için hazir.'
},
{
  order: 6,
...
},
{
  ...
  status: 'ready',
  note: 'Disiplin KPI paneli için hazir.'
}];
...
export const ISG_TOPICS: IsgTopicDefinition[] = [
{
  ...
  description: 'Seçilen yilin aksiyon durumu verileri ile giderilme performansi olculur.',
  status: 'active',
  ownerUnit: 'ISG',
...
},
{
  ...
  description: "Bölümler arasi denetim bulgulari için oran bazlı izleme paneli.",
  status: 'active',
  ownerUnit: 'ISG + Bakım',
  dataSource: '20.02.2026 Capraz Denetim Uygunsuzluk Takip.xlsx',
  iconKey: 'capraz'
...
},
{
  ...
  description: "Olay ifadesi eksik kayitlarin sure bazlı takip paneli.",
  status: 'pipeline',
  ownerUnit: 'ISG + IK',
  dataSource: 'KAZA IFADE GELMEYENLER.xlsx',
  iconKey: 'ifade'
},
{
  ...
  description: "Davranis güvenliği sistemi ile iliskili sari kart tamamlama takibi.",
  status: 'pipeline',
